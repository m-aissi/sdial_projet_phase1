...
public class CreneauSingleton implements FileHandler {
    private List<Creneau> listeCreneau = new ArrayList<>();
    private static final CreneauSingleton instance = new CreneauSingleton();
    private Creneau lastCreneauTouched;

    private Boolean isInit = false;
    private CreneauSingleton() {
    }

    public static CreneauSingleton getInstance() {
        return instance;
    }
    ...
    public void lecture(String nomFichier) throws IOException {
        ...
        InputStream is = CreneauSingleton.class.getResourceAsStream(nomFichier);
